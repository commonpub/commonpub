...
> **Current LIVE (all 3 instances):** schema **0.63** / config **0.35** / infra **0.19** / server **2.124** /
> layer **0.121**, migration **0045**, 38 flags. **Layer 0.119 = post-launch hotfix: contest hero mobile
