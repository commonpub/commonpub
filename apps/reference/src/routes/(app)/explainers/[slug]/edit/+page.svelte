...
<div class="edit-page">
  ...
  <form method="POST" use:enhance>
    <div class="form-field">
      <Input id="title" label="Title" name="title" bind:value={title} required maxlength={255} />
    </div>

    <div class="form-field">
      <Textarea id="description" label="Description" name="description" bind:value={description} maxlength={2000} rows={2} />
    </div>
    ...
    <div class="form-field">
      <Input id="tags" label="Tags (comma-separated)" name="tags" bind:value={tags} />
    </div>

    <div class="form-field">
      <Textarea id="seoDescription" label="SEO Description (optional)" name="seoDescription" bind:value={seoDescription} maxlength={320} rows={2} />
    </div>
