...
function makeConfig(idOverrides: Partial<CommonPubConfig['features']['identity']> = {}): CommonPubConfig {
  return {
    ...
    features: {
      ...
      federateHubs: false, admin: false, themeStudio: true, emailNotifications: false, emailUnverified: false,
    emailVerification: false, contestActionBar: true, analytics: false, adminBroadcast: false, requireTermsAcceptance: false,
