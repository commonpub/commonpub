...
/**
 * Re-fetch remote objects for federated content with missing cpubType.
 * Updates cpubType from the cpub:type extension field in the source AP object.
 */
export async function repairFederatedContentTypes(
  db: DB,
  limit = 500,
