...
CREATE TYPE "public"."comment_target_type" AS ENUM('project', 'article', 'blog', 'explainer', 'post', 'lesson');--> statement-breakpoint
...
CREATE TYPE "public"."contest_status" AS ENUM('upcoming', 'active', 'judging', 'completed');--> statement-breakpoint
...
CREATE TYPE "public"."like_target_type" AS ENUM('project', 'article', 'blog', 'explainer', 'comment', 'post');--> statement-breakpoint
...
CREATE TYPE "public"."notification_type" AS ENUM('like', 'comment', 'follow', 'mention', 'contest', 'certificate', 'hub', 'system', 'fork', 'build');--> statement-breakpoint
...
ALTER TABLE "docs_nav" ADD CONSTRAINT "docs_nav_version_id_docs_versions_id_fk" FOREIGN KEY ("version_id") REFERENCES "public"."docs_versions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_videos_author_id" ON "videos" USING btree ("author_id");