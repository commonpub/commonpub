...
<style scoped>
.cpub-block-image { margin: 24px 0; }
.cpub-image-img { width: 100%; display: block; border: var(--border-width-default) solid var(--border); }
.cpub-image-caption { font-size: 12px; font-family: var(--font-mono); color: var(--text-faint); padding: 8px 0; text-align: center; }
</style>
