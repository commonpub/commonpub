...
Rust CLI for scaffolding new Snaplify instances.

## Overview

Generates a ready-to-deploy Snaplify project with all configuration files, Docker setup, and package dependencies. Supports both interactive prompts and headless defaults.
...
my-community/
  ...
  snaplify.config.ts      # Instance configuration
