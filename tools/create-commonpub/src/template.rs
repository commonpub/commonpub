...
const COMMONPUB_CONFIG_VERSION: &str = "^0.26.0";
const COMMONPUB_LAYER_VERSION: &str = "^0.89.1";
const COMMONPUB_SCHEMA_VERSION: &str = "^0.54.0";
const COMMONPUB_SERVER_VERSION: &str = "^2.100.1";
