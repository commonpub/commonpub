...
const COMMONPUB_CONFIG_VERSION: &str = "^0.33.0";
const COMMONPUB_LAYER_VERSION: &str = "^0.105.0";
const COMMONPUB_SCHEMA_VERSION: &str = "^0.59.0";
const COMMONPUB_SERVER_VERSION: &str = "^2.112.0";
