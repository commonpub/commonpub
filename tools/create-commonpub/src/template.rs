...
const COMMONPUB_CONFIG_VERSION: &str = "^0.30.0";
const COMMONPUB_LAYER_VERSION: &str = "^0.97.0";
const COMMONPUB_SCHEMA_VERSION: &str = "^0.56.0";
const COMMONPUB_SERVER_VERSION: &str = "^2.105.0";
