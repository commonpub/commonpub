...
const COMMONPUB_CONFIG_VERSION: &str = "^0.31.0";
const COMMONPUB_LAYER_VERSION: &str = "^0.99.0";
const COMMONPUB_SCHEMA_VERSION: &str = "^0.57.0";
const COMMONPUB_SERVER_VERSION: &str = "^2.107.0";
