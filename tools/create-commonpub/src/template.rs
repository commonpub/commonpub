...
//
// Last synced: 2026-06-08 (session 192, Theme Studio guided generator) — layer 0.65.0,
// server 2.83.0, schema 0.36.0, config 0.20.0. (theme-studio installs transitively via the
...
const COMMONPUB_LAYER_VERSION: &str = "^0.65.0";
const COMMONPUB_SCHEMA_VERSION: &str = "^0.36.0";
